...
from tc_engine.engine_virtuoso import export_work_graph_ttl, OUT_TTL  
...
if __name__ == "__main__":
    run_experiment(
        ...
        shapes_graph_uri="source/ShapesGraphs/expanded_shapes.ttl",
        ontology_uri="source/dbpedia_ontology_inflated.ttl",
    )
