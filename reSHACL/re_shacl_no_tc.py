...
def merged_graph_no_tc(
    ...
    ontology: Union[GraphLike, str, bytes],
    shacl_graph: Optional[Union[GraphLike, str, bytes]] = None,
    data_graph_format: Optional[str] = None,
    shacl_graph_format: Optional[str] = None,
    ...
    ontology_graph.parse(ontology, ontology_format)  
    ...
    with timer_ns(timing, "tc_engine_expand_and_rewrite_ns"):
        shape_g, target_classes, _cache = expand_target_classes_cached(shape_g, ontology_graph, target_classes)
